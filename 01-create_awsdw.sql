...
-- O código abaixo refere-se a criação das tabelas no DW.
...
CREATE TABLE DimCustomer
    (
      CustomerKey INT NOT NULL sortkey distkey, -- utiliza-se a distribuição key: os relacionamentos conhecidos são mantidos no mesmo node.
...
CREATE TABLE DimDate
    ...
    ) DISTSTYLE ALL;  -- distribuição all: todos os registros são copiados para todos os nodes.
                      -- o campo Date irá mudar muito pouco, logo ideal para All Distribution.
...
CREATE TABLE FactProductInventory -- Criação da primeira tabela FATO.
    (
...
CREATE TABLE FactRate  -- Criação da segunda tabela FATO.
    (
      CurrencyKey INT NOT NULL ,
      DateKey INT NOT NULL distkey sortkey,
...
CREATE TABLE FactSales -- Criação da terceira tabela FATO.
    (
      ProductKey INT NOT NULL ,
      OrderDateKey INT NOT NULL distkey sortkey,
      DueDateKey INT NOT NULL ,
      ShipDateKey INT NOT NULL ,
      ControlKey INT NOT NULL ,
